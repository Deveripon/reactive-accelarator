...
import { Github, ExternalLink, Users, GitCommit } from "lucide-react"
      ...
      <div className="container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Reactive Accelerator is made possible by our incredible community of developers who contribute their time,
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 md:p-12 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Want to contribute to Reactive Accelerator? We welcome contributions of all kinds - from fixing typos to
              adding new tutorials and features.
            </p>
