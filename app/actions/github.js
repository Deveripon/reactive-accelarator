...
export async function getGitHubContributors() {
    try {
        const response = await fetch(
            "https://api.github.com/repos/Deveripon/reactive-accelarator/contributors",
            {
                headers: {
        ...
        return contributors.slice(0, 100); // Limit to top 12 contributors
    } catch (error) {
...
export async function getGitHubStats() {
    try {
        const response = await fetch(
            "https://api.github.com/repos/Deveripon/reactive-accelarator",
            {
                headers: {
                    Accept: "application/vnd.github.v3+json",
                    "User-Agent": "Reactive-Accelerator-Website",
