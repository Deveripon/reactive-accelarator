...
**যখন আমরা চাই যে আমাদের কোন কম্পোনেন্ট কে কোন ভ্যালু ধরে রাখবে, এবং আমরা তা চেঞ্জ করলেও আমাদের কম্পোনেন্ট রি-রেন্ডার করবেনা, সেই ক্ষেত্রে আমারা `useRef` ব্যাবহার করবো।**
...
আমরা `useRef` এর `current` প্রপার্টির মধ্যে কোন রেফারেন্স বা ভ্যালু স্টোর করে রাখতে পারি, এবং সেটা রিয়াক্টের স্টেট চেঞ্জ হলেই কম্পোনেন্ট সেই ভ্যালু টা ধরে রাখবে। অর্থাৎ আমরা `ref` কে কম্পোনেন্ট এর এমন একটা স্টোরেজ হিসাবে রাখতে ব্যাবহার করতে পারি যে, আমদের স্টেট চেঞ্জ হয়ে কম্পোনেন্ট যতবার রি-রেন্ডার হোক না কেন,আমাদের সেই স্টোর করা ডাটা হারাবেনা।
...
**যহেতু InrevalId আমদের রেন্ডারিং এর মাঝে ব্যাবহার হয়না,তাই আমরা IntervalId কে স্টোর করার জন্য `useRef` ব্যাবহার করতে পারি।**
